...
export default function Navbar() {
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 sticky top-0 z-30 px-4 sm:px-6 flex items-center justify-between shadow-2xs relative">
      ...
      {/* Center: Quick Search */}
      <div className="btn-moving-light hidden md:flex items-center relative w-72 lg:w-96 rounded-xl bg-blue-50/50 dark:bg-slate-900 border border-blue-200/90 dark:border-slate-700/90 shadow-[0_0_15px_rgba(59,130,246,0.25)] overflow-hidden">
