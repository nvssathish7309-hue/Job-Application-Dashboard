    ...
    <header className="h-16 bg-white border-b border-slate-200 sticky top-0 z-30 px-4 sm:px-6 flex items-center justify-between shadow-2xs">
      ...
      <div className="hidden md:flex items-center relative w-72 lg:w-96">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 text-xs bg-slate-50 border border-slate-200 rounded-xl text-slate-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all"
        />
      </div>

      {/* Right: User Profile, Role Badge, Notifications, Logout */}
      <div className="flex items-center gap-3">
